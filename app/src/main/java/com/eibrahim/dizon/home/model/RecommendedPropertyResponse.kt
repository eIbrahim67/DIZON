...
data class RecommendedPropertyResponse(
    val pageIndex: Int,
    val pageSize: Int,
    val totalCount: Int,
...
data class PropertyData(
    @SerializedName("\$id") val id: String,          // Maps "$id" from JSON to id
    @SerializedName("\$values") val values: List<Property>  // Maps "$values" to values
)
